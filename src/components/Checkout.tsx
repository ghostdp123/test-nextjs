  ...
  return (
    <div>
            ...
            <Select onValueChange={setSelectAddress}>
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  {addressesData.map(item => <SelectItem key={item.id} value={item.id.toString()}>
      ...
      <div className="border-b py-4">
        ...
        {cartList.length === 0 ? (
          <div className="my-2">
            <p>You don&#39;t have anything in your cart. Let&#39;s change that, use the link below to start browsing our products.</p>
            <div className="flex text-sm items-center underline text-orange-400">
            ...
            <Table>
              ...
              <TableFooter>
                <TableRow>
                  ...
                  <TableCell className="text-right">￥{cartList.reduce((acc, cartItem) => acc + cartItem.product.price * cartItem.quantity, 0).toFixed(2)}</TableCell>
                </TableRow>
              </TableFooter>
            </Table>
          </div>
